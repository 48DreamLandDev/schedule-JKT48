...
const getTheater = async () => {
    let browser;
    try {
        // Bypass Cloudflare dengan Puppeteer (optimized untuk performa)
        browser = await puppeteer.launch({
            headless: 'new', // Menggunakan headless mode terbaru
            args: [
                '--no-sandbox',
        ...
        // Optimasi page untuk performa
        await page.setCacheEnabled(false); // Disable cache untuk konsistensi
        await page.setJavaScriptEnabled(true); // Pastikan JS enabled untuk Cloudflare
        
        // Set user agent
        await page.setUserAgent('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36');
        
        // Block resources yang tidak perlu untuk hemat bandwidth
        ...
        // Navigate to the page dengan timeout lebih pendek
        await page.goto("https://takagi.sousou-no-frieren.workers.dev/theater/schedule", {
            waitUntil: 'domcontentloaded', // Lebih cepat dari networkidle2
            timeout: 15000 // Timeout lebih pendek
        });
        
        // Wait for content to load
        await page.waitForSelector('div.table-responsive.table-pink__scroll', { timeout: 10000 });
